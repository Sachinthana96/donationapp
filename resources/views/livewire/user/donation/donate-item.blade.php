<div>
    <button wire:click="openModal"
        class="bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300
    dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800 transition duration-300
            ...
            <div class="flex items-start justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                ...
                <div x-cloak x-transition:enter="transition ease-out duration-300 transform"
                    ...
                    <div class="flex items-center justify-between space-x-4">
                        <h1 class="text-xl font-medium text-gray-800 ">Donate Item</h1>
                    ...
                    <p class="mt-2 text-sm text-gray-500 ">
                        If you click the donate button this item recived.
                    </p>
                    ...
                    <form class="mt-5 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                        ...
                        <div class="mb-6">
                            <label for="receive-count"
                                ...
                                Count : {{ $item->available_quantity }}</label>
                            @error('receiveCount')
